	...
	<div class="row">
		...
		<div class="col-md-4">
			<div class="box box-primary">
				<form id="form" method="post" action='<?= "$base_url/admin/normalisasi-bobot.php"; ?>'>
				...
				<div class="box-footer">
					<a href='<?= "$base_url/?pg=perhitungan-saw"; ?>' class="btn btn-default btn-block"><i class="fa fa-reply"></i> Kembali </a>
